...
namespace AKCondinoO.World{
    internal class WorldChunkManager:MonoSingleton<WorldChunkManager>{
     ...
     internal int terrainLayerMask{get{if(terrainLayerMaskValue!=0){return terrainLayerMaskValue;}return terrainLayerMaskValue=1<<chunkPrefab.terrain.gameObject.layer;}}int terrainLayerMaskValue=0;
