...
namespace AKCondinoO.Voxels{
    internal partial class VoxelSystem{
        ...
        internal class Concurrent{
         ...
         internal static readonly Dictionary<int,Terrain.MarchingCubes.MarchingCubesTerrain.Voxel[]>terrainVoxelsOutput=new Dictionary<int,Terrain.MarchingCubes.MarchingCubesTerrain.Voxel[]>();
