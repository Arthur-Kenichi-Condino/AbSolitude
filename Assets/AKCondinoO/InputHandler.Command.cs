...
namespace AKCondinoO{
    internal partial class InputHandler{
        internal static class Command{
         ...
         internal static CommandState TOGGLE_CONSOLE    =new CommandState{input=KeyCode.Return,mode=Modes.WhenDown};
         internal static CommandState TOGGLE_CAMERA_MODE=new CommandState{input=KeyCode.Backspace,mode=Modes.WhenDown};
